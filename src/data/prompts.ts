// Thư viện prompt tham khảo — lấy cảm hứng cấu trúc từ trang /prompts mẫu, nội dung viết lại riêng.
// Sửa/thêm prompt trực tiếp trong mảng bên dưới.
...
export const promptLibraryIntro = {
  eyebrow: "Thư viện Prompt AI",
  title: "Prompt tham khảo",
  description:
    "Copy, điền thông tin vào chỗ trống, dán vào ChatGPT, Claude, Gemini... và dùng ngay — không cần biết viết prompt.",
};

export const promptStats = [
  { value: "14", label: "Prompt" },
